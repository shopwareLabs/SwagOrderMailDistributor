...
use Swag\OrderMailDistributor\SwagOrderMailDistributor;
...
$swagOrderMailDistributor = [
    'autoload' => $composerJson['autoload'],
    'baseClass' => SwagOrderMailDistributor::class,
    'managedByComposer' => false,
    'active' => true,
    'path' => $pluginRootPath,
];
$pluginLoader = new StaticKernelPluginLoader($classLoader, null, [$swagOrderMailDistributor]);
